...
//
{
  ...
  x = ( int * ) malloc ( (n+1) * sizeof ( int ) ); // COMMENT: size of the allocation had to be changed to (n+1) , which was the reason there was an error !!
  ...
  free(x); // This allocation had to be freed properly.
